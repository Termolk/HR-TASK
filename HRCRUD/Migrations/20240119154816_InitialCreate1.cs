    ...
    public partial class InitialCreate1 : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_TestTasks", x => x.TestTaskId);
                    table.ForeignKey(
                        name: "FK_TestTasks_Candidates_CandidateId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Name = table.Column<string>(type: "TEXT", nullable: false),
                    DepartmentId = table.Column<int>(type: "INTEGER", nullable: false),
                    ClosedVacanciesCount = table.Column<int>(type: "INTEGER", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_HRs", x => x.HRId);
                    table.ForeignKey(
                        name: "FK_HRs_Departments_DepartmentId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_HRs_DepartmentId",
                table: "HRs",
                column: "DepartmentId");

            migrationBuilder.CreateIndex(
                name: "IX_TestTasks_CandidateId",
                table: "TestTasks",
                column: "CandidateId");
